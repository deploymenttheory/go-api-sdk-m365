...
func main() {
	...
	iOSConfigurationProfileName := "intuneSDK test - custom"

	// Use the Intune client to perform operations
	iOSConfigurationProfile, err := intune.GetiOSConfigurationProfileByDisplayName_CustomTemplate(iOSConfigurationProfileName)
	if err != nil {
