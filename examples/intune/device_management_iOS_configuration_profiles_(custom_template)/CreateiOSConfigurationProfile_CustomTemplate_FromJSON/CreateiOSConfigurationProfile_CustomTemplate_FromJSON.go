...
func main() {
	...
	// Read the JSON file
	byteValue, err := os.ReadFile("/Users/dafyddwatkins/GitHub/deploymenttheory/go-api-sdk-m365/examples/intune/device_management_iOS_configuration_profiles_(custom_template)/CreateiOSConfigurationProfile_CustomTemplate_FromJSON/payload.json") // Replace with your JSON file path
	if err != nil {
	...
	var configurationProfileRequest intuneSDK.ResourceiOSConfigurationProfile_CustomTemplate
	err = json.Unmarshal(byteValue, &configurationProfileRequest)
	if err != nil {
	...
	createdPolicy, err := intune.CreateiOSConfigurationProfile_CustomTemplate(&configurationProfileRequest)
	if err != nil {
