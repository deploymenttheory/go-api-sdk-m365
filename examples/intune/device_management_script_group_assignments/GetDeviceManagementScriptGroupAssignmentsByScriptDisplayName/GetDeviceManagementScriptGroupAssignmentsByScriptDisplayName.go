...
func main() {
	...
	deviceManagementScriptName := "[Intune]-[Script]-[Enable_ADAL]"

	// Use the Intune client to perform operations
	deviceManagementScriptGroupAssignments, err := intune.GetDeviceManagementScriptGroupAssignmentsByScriptDisplayName(deviceManagementScriptName)
	if err != nil {
