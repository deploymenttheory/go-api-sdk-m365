...
func main() {
	...
	updateRequest := &intuneSDK.ResourceDeviceShellScript{
		...
		DisplayName:                 "intuneSDK - Updated macOS script By Display Name",
	...
	scriptName := "macOS-shell_script-created_with_intuneSDK_withJSON"

	// Update the Device Shell Script by its ID
	updatedShellScript, err := intune.UpdateDeviceShellScriptByDisplayName(scriptName, updateRequest)
	if err != nil {
